  ...
  var TreeBuilder = (function () {
    ...
    _createClass(TreeBuilder, [{
      ...
      value: function create() {
        ...
        var width = opts.width + opts.margin.left + opts.margin.right-100;
        ...
        .call(zoom).append('g').attr('transform', 'translate(' + width / 2 + ',' + opts.margin.top + ')');
        // Compute the layout.
      ...
      value: function _update(source) {
        ...
        nodes.append('foreignObject').filter(function (d) {
          ...
          opts.callbacks.nodeClick(d.data.name, d.data.extra, d.data.mid);
    ...
    _preprocess: function _preprocess(data, opts) {
      ...
      var reconstructTree = function reconstructTree(person, parent) {
        ...
        var node = {
          ...
          'class': person['classes'] ? person['classes'] : opts.styles.node
        };
        ...
        _.forEach(person.marriages, function (marriage, index) {
          ...
          var spouse = {
            ...
            'class': sp['classes'] ? sp['classes'] : opts.styles.node,
            extra: sp.extra,
            marriageNode: m
          };
